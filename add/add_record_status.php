...
<head>
    <meta charset="UTF-8">
    <title>Создание записи в справочнике - Статусы</title>
...
<body>
    <div class="container">
        <div class="header">
            <a href="/local-pril/status_inventory.php" class="back-button">НАЗАД</a>
            <h1 class="page-title">Статусы: создание</h1>
        </div>
        <div class="form-group">
            <label for="field-value" id="field-label">Статус:</label>
            <input type="text" id="field-value" name="field-value" placeholder="Введите название статуса">
        </div>
    ...
    function addRecord() {
        ...
        BX24.init(function() {
            BX24.callMethod(
                'custom.addiplusreferencestatus',
                { name: fieldValue },
                function(result) {
                    if (result.error()) {
                        ...
                        alert(data.message || 'Статус успешно добавлен');
                        window.location.href = '/local-pril/status_inventory.php';
                    }
                }
            );
        });
